...
# compatible with full_test_data_16digit.csv
...
def main():
    ...
    LAMBDA = 1.5
    TOP_K = 3
    DATA_FILE = 'full_test_data_16digit.csv'
    PIN_LENGTH = 16
    # ===================
    ...
    # verify column count: 1(pin) + 16(ts) + 16*5(features) = 97
    ...
    print("\n" + "=" * 60)
    print("🔐 16-digit PIN inference results")
